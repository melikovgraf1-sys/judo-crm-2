...
export default function Topbar({
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-white/85 backdrop-blur-xl shadow-sm transition-colors duration-300 dark:border-slate-800/60 dark:bg-slate-950/80">
      <div className="mx-auto w-full max-w-7xl px-4 py-2">
        <div className="flex flex-col gap-2">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-500 via-blue-500 to-indigo-500 text-base font-semibold text-white shadow-lg shadow-sky-500/25">
                JC
              </div>
              <div>
                <div className="text-base font-semibold text-slate-900 dark:text-slate-100">Judo CRM</div>
                <p className="text-[11px] text-slate-500 dark:text-slate-400">Современная панель для тренеров и администраторов</p>
              </div>
            </div>
            <div className="flex w-full flex-wrap items-center justify-end gap-2 sm:w-auto sm:flex-1">
              <div className="relative min-w-[180px] w-full flex-1 sm:max-w-sm">
                <span
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-3 rounded-xl border border-slate-200/60 bg-white/70 px-3 py-2 text-left shadow-sm transition dark:border-slate-700/60 dark:bg-slate-900/70">
                ...
                <button
                  type="button"
                  onClick={onLogout}
                  className="ml-2 inline-flex items-center rounded-lg border border-slate-300/70 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-slate-600 transition hover:border-slate-400 hover:text-slate-900 dark:border-slate-700 dark:text-slate-300 dark:hover:border-slate-500 dark:hover:text-white"
                >
                  Выйти
                </button>
              </div>
